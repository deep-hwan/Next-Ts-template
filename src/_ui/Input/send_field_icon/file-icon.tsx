export const FileIcon = ({
    ...
    <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" css={{ cursor: 'pointer' }} {...props}>
        {type === 'file' && (
            <>
        ...
        {type === 'photo' && (
            <>
                <g clip-path="url(#clip0_18_2)">
                    <path
                        d="M13.145 11.506L21.882 18.061C21.9591 17.7125 21.9986 17.3569 22 17V14.234L15.477 9.174L13.145 11.506Z"
                        fill={iconColor}
                    />
                    <path
                        d="M0.515991 19.172C0.921748 20.0174 1.55773 20.7312 2.3509 21.2315C3.14407 21.7317 4.06225 21.9981 4.99999 22H17C17.7543 21.998 18.4983 21.8243 19.1755 21.4922C19.8528 21.1601 20.4456 20.6782 20.909 20.083L7.86499 10.3L0.515991 19.172Z"
                        fill={iconColor}
                    />
                    <path
                        d="M17 0H5C3.67392 0 2.40215 0.526784 1.46447 1.46447C0.526784 2.40215 0 3.67392 0 5L0 16.324L6.864 8.085C7.04585 7.87143 7.30242 7.7354 7.58125 7.70473C7.86007 7.67406 8.14007 7.75107 8.364 7.92L11.364 10.175L14.664 6.875C14.856 6.68529 15.1111 6.57281 15.3807 6.55898C15.6503 6.54515 15.9156 6.63094 16.126 6.8L22 11.44V5C22 3.67392 21.4732 2.40215 20.5355 1.46447C19.5979 0.526784 18.3261 0 17 0Z"
                        fill={iconColor}
                    />
                </g>
                <defs>
